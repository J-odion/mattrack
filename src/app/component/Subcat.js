...
export default function Subcat() {
  ...
  return (
    <section className="py-[26px] gap-y-[14px] w-full h-[90%] lg:w-[1280px] text-[12px] justify-center flex flex-col mx-auto items-center">
      ...
      <div className="w-full h-[80%] overflow-scroll pb-8 ">
